const Constants = {
  textNodes: [
      ...
      options: [
        {
          id: 1,
          text: "Continue",
          requireState: {'cheese': 1},
          nextText: 71,
        },
        {
          id: 1,
          text: "Continue",
          requireState: {'purple carrot': 1},
          nextText: 72,
        }
      ],
    },
    ...
    {
      id: 79,
      text: "Eisenhopper safely returned to his village with 6 delicious carrots! Maybe next time he will find more...",
      options: [
        {
          id: 1,
          text: "Restart game?",
